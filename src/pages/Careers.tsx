...
const PILLARS = [
  { k: "Engineer globally", body: "Work across our Madurai R&D centre and Milan design studio — one team, two continents, products that ship to 85+ countries.", icon: "globe" },
